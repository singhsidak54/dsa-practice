...
public class SingleNumberII {
    ...
    public Long solve(int A, ArrayList<Integer> B) {
        ...
        return (long) (Math.pow(2, ones + 1) - 1);
    }

    public static int dfs(StringBuilder str, int A, int B) {
        if(A == 0) {
            return str.charAt(B - 1) == '0' ? 0 : 1;
        } else {
    ...
    public static int solve(int A, int B) {
        ...
        return dfs(new StringBuilder("0"), A - 1, B);
    }
